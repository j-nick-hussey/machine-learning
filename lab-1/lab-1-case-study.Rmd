...
2.   Significantly more males to females
...
-   Columns are listed horizontally

-   Both text and numeric present
...
-   date_registration is not in date format but a whole number

-   final_results = Distinction does not equal a pass

-   code_presentation is identical for all rows
...
-   According to the data, students with a disability pass at lower
    frequencies.
...
-   The percent column explains out of 6,519 data points what percent is
    FALSE, TRUE, or NA. Those 3 percent values add up to 1.
